...
newData = pd.read_csv('/Users/khushnarang/PycharmProjects/FirstWork/DataRecived/Combination3.csv')
...
newData.to_csv('/Users/khushnarang/PycharmProjects/FirstWork/DataRecived/Combination3.csv', index=False)
